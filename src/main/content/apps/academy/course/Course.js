...
import {withStyles, Hidden, Icon, IconButton, Fab, Typography, Stepper, Step, StepLabel, Switch} from '@material-ui/core';
...
class Course extends Component {
    ...
    render()
    {
      ...
      //  this.props.updateCourse({course: course});
                                        ...
                                        <div className="flex justify-center p-16 pb-64 sm:p-24 sm:pb-64 md:p-48 md:pb-64" key={step.id}>
                                            <Paper className="w-full max-w-lg rounded-8 p-16 md:p-24" elevation={1}>
                                                ...
                                                {/* <div dangerouslySetInnerHTML={{__html: step.content}}/> */}
                                                    ...
                                                    {index === 1?<Address/>:null}
                                                    {index === 2?<div dangerouslySetInnerHTML={{__html: step.content}}/> :null}
